                            ...
                            <form method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_barang" class="form-control" id="exampleInputEmail1" value="<?php echo $d['nama_barang']; ?>" placeholder="Masukan Nama Barang">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Jenis Barang</label>
                                        <input type="text" name="jenis_barang" class="form-control" id="exampleInputEmail1" value="<?php echo $d['jenis_barang']; ?>" placeholder="Masukan Jenis Barang">
                                    </div>
                                </div>
                                <!-- /.card-body -->
